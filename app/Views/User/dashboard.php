                        ...
                        <tbody>
                            <?php foreach ($history as $h) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="align-middle badge text-dark"><?= $in[2] > 100 && $in[2] < 1000 ? ($in[2]/60).' Hours' : $in[2].' Days' ?></span></td>
                                    <td><span class="align-middle badge text-danger"><?= $in[3] ?> Devices</span></td>
