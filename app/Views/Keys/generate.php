    ...
    <div class="col-lg-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-lg-6 mb-3">
                        <label for="bulk_key" class="form-label">Bulk Keys</label>
                        <input type="number" name="bulk_key" id="bulk_key" class="form-control" placeholder="1" value="<?= old('bulk_key') ?: 1 ?>">
                        <?php if ($validation->hasError('game')) : ?>
                            <small id="help-bulk_key" class="text-danger"><?= $validation->getError('bulk_key') ?></small>
                        <?php endif; ?>
                    </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="estimation" name="estimation" class="form-control" placeholder="Your order will total" readonly>
                </div>
