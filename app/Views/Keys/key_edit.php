        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="text-end">
                            <a class="btn btn-sm btn-outline-light" href="<?= site_url('keys/generate') ?>"><i class="bi bi-plus"></i></a>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-3">
                        <label for="devices" class="form-label">Devices <span class="bg-primary text-white px-1 rounded maxDev"><?= $key_info->total ?>/<?= $key->max_devices ?></span> <small class="text-muted">(Separately with enter)</small></label>
