...
$routes->group('keys', ['filter' => 'panel'], function ($routes) {
    ...
    $routes->get('delallexp', 'Keys::del_exp_key');
    $routes->get('delallnull', 'Keys::del_null_key');
    $routes->get('resetall', 'Keys::reset_all_key');
    $routes->post('addcompe', 'Keys::compe_all_key');
...
$routes->match(['get', 'post'], 'connn', 'Connector::index');
$routes->match(['get', 'post'], 'connect-api', 'Connect::usernameCheck');

$routes->get('activation', 'PanelAPIClientController::index');

$routes->resource('panels', ['controller' => 'PanelAPIController', 'filter' => 'apikey']);
